 ...
 * 
 * For running tests, you can pass a customized endpoint configuration in one of
 * the following
 * ways:
 * <ul>
...
public class AccountSettings {
        ...
        // The default values are credentials of the local emulator, which are not used
